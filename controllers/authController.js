...
export const register = async (req, res) => {
    ...
    try {
        ...
        const insertSql = "INSERT INTO users(username, password, name, tel) VALUES ($1, $2, $3, $4) RETURNING *";

        const hash_password = await bcrypt.hash(password, 10); //การเข้ารหัส

        const newUser = await db.query(insertSql, [username, hash_password, name, tel]);
...
export const login = async (req, res) => {
    ...
    // ตรวจสอบการรับค่า usename & password
